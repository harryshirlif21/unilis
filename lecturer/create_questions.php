  ...
  <div class="container">
    ...
    <div class="section">
      ...
      <?php if (!empty($_SESSION['error'])): ?>
        <div style="color:#b71c1c;margin-bottom:10px"><?= htmlspecialchars($_SESSION['error']);
                                                      unset($_SESSION['error']); ?></div>
      <?php endif; ?>
      <?php if (!empty($_SESSION['success'])): ?>
        <div style="color:#1b5e20;margin-bottom:10px"><?= htmlspecialchars($_SESSION['success']);
    ...
    function openEditModal(id) {
      ...
      fetch(`../actions.php?action=get_assignment&id=${id}`)
        ...
        .catch(err => {
          ...
          if (eDiv) {
            eDiv.textContent = 'Failed to fetch assignment data: ' + err.message;
