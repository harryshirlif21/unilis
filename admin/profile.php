    ...
    try {
        if ($_POST['action'] === 'update_profile') {
            ...
            if ($user_role === 'student') {
                ...
                $stmt = $conn->prepare($sql);
                $stmt->bind_param("sssssi", $name, $email, $phone, $bio, $date_of_birth, $address, $user_id);
            }
    ...
    <style>
        ...
        * {
        ...
        .form-input:focus {
            ...
            box-shadow: 0 0 0 0 3px rgba(99, 102, 241, 0.1);
        }
        ...
        <div class="modal-content">
            ...
            <form id="settingsForm">
                ...
                <div class="settings-section">
                    ...
                    <div class="form-group">
                        <div class="form-switch">
                            <label class="form-label" style="margin: 0;">Enable 2FA</label>
                            <div class="switch <?= ($user_settings['two_factor_enabled'] ?? 0) ? 'active' : '' ?>" onclick="toggleSwitch(this)">
                                <div class="switch-thumb"></div>
                            </div>
                            <input type="hidden" name="two_factor_enabled" value="<?= $user_settings['two_factor_enabled'] ?? 0 ?>">
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <div class="form-switch">
                            <label class="form-label" style="margin: 0;">Active Sessions</label>
                            <div class="switch <?= ($user_settings['active_sessions'] ?? 0) ? 'active' : '' ?>" onclick="toggleSwitch(this)">
                                <div class="switch-thumb"></div>
                            </div>
                            <input type="hidden" name="active_sessions" value="<?= $user_settings['active_sessions'] ?? 0 ?>">
                        </div>
                    </div>
                </div>
