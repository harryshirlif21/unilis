<?php
// Database migration script for team_membership_requests table
header('Content-Type: application/json');

try {
    require_once __DIR__ . '/../../config/db.php';
    
    $sql = "CREATE TABLE IF NOT EXISTS `team_membership_requests` (
    ...
    if ($conn->query($sql) === TRUE) {
        echo json_encode([
            'success' => true,
            'message' => 'Table team_membership_requests created successfully or already exists'
        ]);
    } else {
