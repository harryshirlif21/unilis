...
<script>
// CSRF token embedded safely from PHP session
...
/* ── Safe JSON fetch — always returns parsed data or throws a clean error ── */
async function safeFetch(url, options = {}) {
    ...
    try {
        ...
        // Server returned non-JSON (PHP error HTML) — log it and throw cleanly
        console.error(`Non-JSON response from ${url}:`, text);
        throw new Error(`Server error from ${url.split('/').pop()} — check PHP error log`);
    }
}
