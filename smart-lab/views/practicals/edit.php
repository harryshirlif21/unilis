        ...
        <form method="POST" action="<?= APP_URL ?>/practicals/edit/<?= $practical['id'] ?>" class="modern-form">
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description-editor" class="form-control tinymce-editor" rows="8" placeholder="Describe the practical objectives and procedures..."><?= $practical['description'] ?? '' ?></textarea>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="results_template" id="results-template" class="form-control tinymce-editor" rows="6" placeholder="Create a table template for students to record their experimental results..."><?= $practical['results_template'] ?? '' ?></textarea>
                </div>
                
                <div class="form-group">
                    <label class="form-label">Calculations & Observations Template</label>
                    <textarea name="calculations_template" id="calculations-template" class="form-control tinymce-editor" rows="6" placeholder="Provide instructions and space for students to show their calculations and observations..."><?= $practical['calculations_template'] ?? '' ?></textarea>
                </div>
            </div>
