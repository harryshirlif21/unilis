...
CREATE TABLE `practicals` (
  ...
  `safety_notes` text DEFAULT NULL,
  `procedure_json` longtext DEFAULT NULL,
  `observations_table_structure` longtext DEFAULT NULL,
  `results_template` text DEFAULT NULL,
  `calculations_template` text DEFAULT NULL,
