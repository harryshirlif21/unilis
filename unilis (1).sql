...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2025 at 11:58 AM
...
(4, 4, 1, 'assignment 1', 'submit on time', '2025-08-09 06:18:00', '2025-07-23 03:19:01', '1753240741_en_FLB.pdf'),
(5, 5, 1, 'bloack chain', 'do all quizes', '2025-08-08 09:56:00', '2025-07-23 06:56:24', '1753253784_kaitheri_timetables.pdf'),
(6, 5, 1, 'assignment 2', 'submit on time', '2025-07-23 12:24:00', '2025-07-23 09:19:26', '1753262366_Data_Repository_and_Unilis_System_Presentation.pptx');
...
(3, 1, 1, '1752563850_Calculus 1 _ 2 - Prof. Okelo.pdf', '2025-07-15 07:17:30'),
(4, 4, 1, '1753242290_kaitheri_timetables.pdf', '2025-07-23 03:44:50'),
(6, 5, 1, '1753253411_en_FLB.pdf', '2025-07-23 06:50:11');
...
INSERT INTO `submissions` (`id`, `assignment_id`, `student_id`, `file_path`, `submitted_at`, `marks`, `is_graded`, `comment`) VALUES
(1, 5, 1, '1753253824_chapter_4.pdf', '2025-07-23 06:57:04', 12, 1, 'you can do better'),
(2, 6, 1, '1753262430_Supps Invigilation Timetable - Computing July 2025.pdf', '2025-07-23 09:20:30', 23, 1, 'good work');
...
--
ALTER TABLE `meetings`
  ADD CONSTRAINT `meetings_ibfk_1` FOREIGN KEY (`lecturer_id`) REFERENCES `lecturers` (`id`),
  ADD CONSTRAINT `meetings_ibfk_2` FOREIGN KEY (`unit_id`) REFERENCES `units` (`id`);
