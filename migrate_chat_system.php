...
CREATE TABLE IF NOT EXISTS `chat_messages` (
  ...
  `body` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Empty string when the message is a file with no accompanying text.',
  ...
  `attachment_path` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Relative to uploads/chat/. Served only via chat/api/file.php.',
  `attachment_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Original filename, for display and download.',
  `attachment_size` int unsigned DEFAULT NULL,
  `attachment_mime` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
